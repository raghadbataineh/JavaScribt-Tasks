...
// fetch('MOCK_DATA.json') // Replace 'data.json' with the actual path or URL to your JSON file if it's hosted on a server.
//   .then(response => response.json())
//   .then(data => {
//     // Process the JSON data here
//     let myarray=data; // Example: { "name": "John Doe", "age": 30, "email": "john@example.com" }
//   })
//  ;
