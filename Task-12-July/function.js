...
let age=prompt ("Enter you puppey age ")
calculateDogAge(age);
...
function cube(length){
  let cubic=length**3;
  console.log(`the cube on number is ${cubic}`)
}
let length=prompt ("enter the length of the cube");
function cube(length);
...
function sameLength (str1 , str2){
  if (str1.length == str2.length){
    console.log (" those strings have the same length");
  }
  else {
    console.log ("False")
  }
...
console.log("the smaller number is"smallerNubmer (num1,num2,num3));
...
function isodd(number){
  if (!(number%2==0)){
    console.log("is odd True")
  }
  else {
    console.log (" is even false")
  }
}
let number=prompt("Enter number");
isodd (number);
...
let n3=parseInt(prompt("Enter the  number3:"));
let n4=parseInt(prompt("Enter the  number4:"));
let n5=parseInt(prompt("Enter the  number5:"));

console.log("The Average" , average (n1 , n2 , n3 , n4 , n5));
...
function randomBetweenNumbers(min,max) {
  ...
  console.log(`Random value between ${min} and ${max} is ${random_number}`)
...
function scoreInUniversty (mark){
  if (mark>=95 && mark<=100){
    console.log("scoreInUniversty A" )
